        ...
        <div className="carousel-wrapper w-full lg:h-4/5 md:h-3/4 ">
          ...
          >
            <div className="bg-primary-300 lg:w-2/3 w-5/6 lg:h-[23rem] h-5/6 mx-auto flex-start rounded-md my-4 flex flex-col justify-center items-center gap-3 px-3 py-4 shadow-lg text-white">
              ...
              <Link
                href="#footer"
                className="border-[1px] rounded-md border-accent text-primary py-1 px-5 font-sans font-semibold hover:bg-white hover:text-primary-300 focus:bg-white focus:text-primary-300"
              >
                VIEW LOCATION
              </Link>
            </div>
            ...
            <div className="bg-primary-300 text-white lg:h-[25rem] lg:w-2/3 w-5/6 h-5/6 mx-auto rounded-md my-4 flex flex-col justify-center items-center gap-3 px-3 py-4 shadow-lg">
              ...
              <button
                className="border-[1px] rounded-md border-accent text-primary py-1 px-5 font-semibold lg:text-xl hover:bg-white hover:text-primary-300 focus:bg-white focus:text-primary-300"
                onClick={() =>
                  window.open(
            ...
            <div className="bg-primary-300 lg:w-2/3 w-5/6 h-5/6 mx-auto lg:h-[25rem] rounded-md my-4 flex flex-col justify-center items-center gap-3 px-3 py-6 shadow-lg text-white">
              ...
              <Link
                href="#footer"
                className="border-[1px] rounded-md border-accent text-primary py-1 px-5 font-semibold hover:bg-white hover:text-primary-300 focus:bg-white focus:text-primary-300"
              >
                VIEW LOCATION
              </Link>
            </div>
